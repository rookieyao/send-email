...
public class AddresserPool implements Addresser {
    ...
    /** 账号每天最大发送邮件数*/
    public static final int maxSendNum = 30;
    ...
    private static void initContent(){
        ...
        String str3 = "您好,%s年度卫生资格考试通知+扣%s了解详情";
        ...
        String str9 = "临近考试，想了解更多,%s年度卫生资格考试通知+扣%s了解详情";
        ...
        String str17= "考试是弹簧，你弱它就强，要想考得好，可以联系内部考试332993701/包拿证/";
        String str18 = "你好，给你发邮件是想告诉你，你与卫生资格考试通过只差一个我，可以加内部老师 332993701/包拿证/";
        String str19= "用户你好，卫生考试没通过，可以联系内部老师，332993701/包拿证/";
        String str20 = "很抱歉打扰你，给你发邮件是为了告诉你，2021年度卫生资格考试未通过/内部复核查询成绩/修改成绩/百分百一次合格/加内部老师扣+332993701/包拿证/";
